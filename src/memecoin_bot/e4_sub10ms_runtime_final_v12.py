...
from . import e4_sub10ms_transport_final_v12 as transport

core = transport.core
LOGGER = logging.getLogger("gambit.e4.sub10ms.runtime.final.v12")

_PREVIOUS_RUN = core.Engine.run


async def _run_with_final_prewarm(self):
    ...
    try:
        ...
        if callable(close):
            try:
                ...
                LOGGER.exception("V12 final persistent sender cleanup failed")


core.Engine.run = _run_with_final_prewarm
