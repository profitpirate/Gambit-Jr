-- Gambit Jr owned SQL. Dune schemas checked against official docs 2026-08-29.
...
SELECT token_address, observed_at, creator, tx_id, block_slot, 'pumpfun_transaction' AS source
FROM observed_mints
WHERE occurrence = 1
