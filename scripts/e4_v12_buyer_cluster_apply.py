...
import e4_v12_buyer_cluster_search as search
import e4_v12_golden_thesis_search_v2 as golden
import e4_v12_true_latency_replay as replay


def main() -> int:
    parser = argparse.ArgumentParser(description="Apply a frozen winning first-buyer cluster thesis")
    ...
    if frozen.get("status") != "HISTORICAL_GOLDEN_CONFIRMED":
        raise SystemExit("buyer-cluster thesis was not historically confirmed")
    ...
    payload = {
        "version": "e4-v12-buyer-cluster-live-v1",
