#!/usr/bin/env python3
"""Validate and atomically register one frozen-V11 live capture."""
...
import e4_v12_relative_price_capped_actor_holdout as holdout

SCHEMA_VERSION = "e4-v12-relative-price-capture-registration-v1"
BATCH_NAME = "e4-v12-v11-forward-batch.json"
EVENTS_NAME = "e4-v12-v11-forward-batch-live-events.jsonl"
...
def capture_record(
    ...
    return {
        ...
        "artifact_name": f"e4-v12-v11-forward-{run_id}",
